...
var COURSE_WIDTH = "1800";
var COURSE_HEIGHT = "1800";
...
function doLMSInitialize()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API + '\n' + LMSINITIALIZE_WAS_NOT_SUCCESSFUL");
      return "false";
   }
...
function doLMSFinish()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSFINISH_WAS_NOT_SUCCESSFUL");
      return "false";
   }
   else
   {
...
function doLMSGetValue(name)
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSGETVALUE_WAS_NOT_SUCCESSFUL")
      return "";
   }
   else
   {
...
function doLMSSetValue(name, value)
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSSETVALUE_WAS_NOT_SUCCESSFUL");
      return;
   }
   else
   {
...
function doLMSCommit()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSCOMMIT_WAS_NOT_SUCCESSFUL");
      return "false";
   }
   else
   {
...
function doLMSGetLastError()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSGETLASTERROR_WAS_NOT_SUCCESSFUL");
...
function doLMSGetErrorString(errorCode)
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSGETERRORSTRING_WAS_NOT_SUCCESSFUL")
   }
...
function doLMSGetDiagnostic(errorCode)
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSGETDIAGNOSTIC_WAS_NOT_SUCCESSFUL");
   }
...
function LMSIsInitialized()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API LMSISINITIALIZED_FAILED");
      return false;
   }
   else
   {
...
function ErrorHandler()
{
   ...
   if (api == null)
   {
	  ...
	  //console.log("UNABLE_TO_LOCATE_THE_LMS_API CANNOT_DETERMINE_LMS_ERROR_CODE");
      return;
   }
...
function findAPI(win)
{
   while ((win.API == null) && (win.parent != null) && (win.parent != win))
   {
      ...
      if (findAPITries > 7) 
      {
		 ...
		 //console.log("ERROR_FINDING_API_TOO_DEEPLY_NESTED");
         return null;
      }
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
	  ...
	  //console.log("UNABLE_TO_FIND_AN_API_ADAPTER");
   }
   return theAPI
}
