...
function oyCrosswordPuzzle(
	...
	home,	// relative location of js libraries and image files relative to the main HTML file where puzzle is embedded, i.e. "./crossword"
...
oyCrosswordPuzzle.prototype.init = function () {
    this.hlist = new oyClueList(this, "<b>Horizontal</b>", this.hclues, "oygHClue", "H");
    this.vlist = new oyClueList(this, "<b>Vertical</b>", this.vclues, "oygVClue", "V");
...
oyCrosswordPuzzle.prototype.fillIn = function (cell, x, y, i, idx, dir) {
    if (i == 0) {
        cell.style.backgroundImage = "url('css/crossword/img/" + (idx + 1) + ".gif')";
